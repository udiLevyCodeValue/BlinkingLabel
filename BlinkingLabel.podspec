...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.homepage         = "https://github.com/udiLevyCodeValue/BlinkingLabel"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Udi" => "udil@codevalue.net" }
  s.source           = { :git => "https://github.com/udiLevyCodeValue/BlinkingLabel.git", :tag => s.version.to_s }
